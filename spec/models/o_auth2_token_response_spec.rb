...
# Unit tests for OryClient::OAuth2TokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryClient::OAuth2TokenResponse do
  let(:instance) { OryClient::OAuth2TokenResponse.new }

  describe 'test an instance of OAuth2TokenResponse' do
    it 'should create an instance of OAuth2TokenResponse' do
      expect(instance).to be_instance_of(OryClient::OAuth2TokenResponse)
    end
  end
