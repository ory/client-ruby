...
describe OryClient::UiNodeInputAttributes do
  ...
  describe 'test attribute "autocomplete"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["email", "tel", "url", "current-password", "new-password", "one-time-code", "username", "username webauthn"])
  ...
  describe 'test attribute "node_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["input"])
      # validator.allowable_values.each do |value|
