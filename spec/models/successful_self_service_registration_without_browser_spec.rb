...
# Unit tests for OryClient::SuccessfulSelfServiceRegistrationWithoutBrowser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryClient::SuccessfulSelfServiceRegistrationWithoutBrowser do
  let(:instance) { OryClient::SuccessfulSelfServiceRegistrationWithoutBrowser.new }
  ...
  describe 'test an instance of SuccessfulSelfServiceRegistrationWithoutBrowser' do
    it 'should create an instance of SuccessfulSelfServiceRegistrationWithoutBrowser' do
      expect(instance).to be_instance_of(OryClient::SuccessfulSelfServiceRegistrationWithoutBrowser)
    end
  end
