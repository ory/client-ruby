...
describe 'APIKeysApi' do
  ...
  # unit tests for admin_batch_import_api_keys
  ...
  # @param batch_import_api_keys_request BatchImportAPIKeysRequest imports multiple external API keys in one request. The maximum batch size is 1000 keys.
  # @param [Hash] opts the optional parameters
  # @return [BatchImportAPIKeysResponse]
  describe 'admin_batch_import_api_keys test' do
    it 'should work' do
  ...
  # unit tests for admin_revoke_api_key
  # Revoke API Key
  ...
  # @param key_id Identifier of the API key resource.
  # @param admin_revoke_api_key_body 
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'admin_revoke_api_key test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
