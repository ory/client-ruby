...
describe 'OAuth2Api' do
  ...
  # unit tests for delete_rotated_o_auth2_client_secrets
  ...
  # @param [Hash] opts the optional parameters
  # @return [OAuth2Client]
  describe 'delete_rotated_o_auth2_client_secrets test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for o_auth2_device_flow
  ...
  describe 'o_auth2_device_flow test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for perform_o_auth2_device_verification_flow
  ...
  # @param [Hash] opts the optional parameters
  # @return [ErrorOAuth2]
  describe 'perform_o_auth2_device_verification_flow test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for rotate_o_auth2_client_secret
  ...
  # @param [Hash] opts the optional parameters
  # @return [OAuth2Client]
  describe 'rotate_o_auth2_client_secret test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
