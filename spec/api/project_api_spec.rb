...
describe 'ProjectApi' do
  ...
  # unit tests for create_organization_onboarding_portal_link
  ...
  describe 'create_organization_onboarding_portal_link test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [CreateProjectApiKeyBody] :create_project_api_key_body 
  ...
  # unit tests for delete_organization_onboarding_portal_link
  # Delete an organization onboarding portal link
  # Deletes a onboarding portal link for an organization.
  # @param project_id 
  # @param organization_id 
  # @param onboarding_portal_link_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_organization_onboarding_portal_link test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for get_organization_onboarding_portal_links
  ...
  describe 'get_organization_onboarding_portal_links test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for update_organization_onboarding_portal_link
  ...
  # @return [OnboardingPortalLink]
  describe 'update_organization_onboarding_portal_link test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
