...
module OryClient
  class OAuth2ConsentRequest
    ...
    attr_accessor :device_challenge_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'device_challenge_id')
        self.device_challenge_id = attributes[:'device_challenge_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          context == o.context &&
          device_challenge_id == o.device_challenge_id &&
    ...
    def hash
      [acr, amr, challenge, client, consent_request_id, context, device_challenge_id, login_challenge, login_session_id, oidc_context, request_url, requested_access_token_audience, requested_scope, skip, subject].hash
    end
