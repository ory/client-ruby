...
module OryClient
  ...
  class UpdateSettingsFlowWithDeviceAuthnMethod < ApiModelBase
    ...
    attr_accessor :deviceauthn_register
    ...
    attr_accessor :deviceauthn_remove
    ...
    def self.attribute_map
      {
        ...
        :'deviceauthn_register' => :'deviceauthn_register',
        :'deviceauthn_remove' => :'deviceauthn_remove',
        :'method' => :'method',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OryClient::UpdateSettingsFlowWithDeviceAuthnMethod` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::UpdateSettingsFlowWithDeviceAuthnMethod`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'deviceauthn_register')
        self.deviceauthn_register = attributes[:'deviceauthn_register']
      end

      if attributes.key?(:'deviceauthn_remove')
        self.deviceauthn_remove = attributes[:'deviceauthn_remove']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deviceauthn_register == o.deviceauthn_register &&
          deviceauthn_remove == o.deviceauthn_remove &&
          method == o.method &&
    ...
    def hash
      [csrf_token, deviceauthn_register, deviceauthn_remove, method, rotate_secret, transient_payload].hash
    end
