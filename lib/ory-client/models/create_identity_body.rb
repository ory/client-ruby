...
module OryClient
  ...
  class CreateIdentityBody < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::CreateIdentityBody`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [credentials, external_id, metadata_admin, metadata_public, organization_id, recovery_addresses, region, schema_id, state, traits, verifiable_addresses].hash
    end
