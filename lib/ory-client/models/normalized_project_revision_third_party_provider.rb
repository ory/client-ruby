...
module OryClient
  class NormalizedProjectRevisionThirdPartyProvider < ApiModelBase
    ...
    attr_accessor :account_linking_mode
    ...
    attr_accessor :additional_id_token_audiences
    ...
    attr_accessor :fedcm_config_url
    ...
    attr_accessor :net_id_token_origin_header
    ...
    attr_accessor :update_identity_on_login
    ...
    def self.attribute_map
      {
        :'aal2_acr_values' => :'aal2_acr_values',
        :'aal2_amr_values' => :'aal2_amr_values',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'aal2_acr_values')
        if (value = attributes[:'aal2_acr_values']).is_a?(Array)
          self.aal2_acr_values = value
        end
      end

      if attributes.key?(:'aal2_amr_values')
        if (value = attributes[:'aal2_amr_values']).is_a?(Array)
          self.aal2_amr_values = value
        end
      end

      if attributes.key?(:'account_linking_mode')
        self.account_linking_mode = attributes[:'account_linking_mode']
      end
      ...
      if attributes.key?(:'update_identity_on_login')
        self.update_identity_on_login = attributes[:'update_identity_on_login']
      end
    ...
    def valid?
      ...
      account_linking_mode_validator = EnumAttributeValidator.new('String', ["automatic", "confirm_with_existing_credential"])
      return false unless account_linking_mode_validator.valid?(@account_linking_mode)
      ...
      update_identity_on_login_validator = EnumAttributeValidator.new('String', ["never", "automatic"])
      return false unless update_identity_on_login_validator.valid?(@update_identity_on_login)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] account_linking_mode Object to be assigned
    def account_linking_mode=(account_linking_mode)
      validator = EnumAttributeValidator.new('String', ["automatic", "confirm_with_existing_credential"])
      unless validator.valid?(account_linking_mode)
        fail ArgumentError, "invalid value for \"account_linking_mode\", must be one of #{validator.allowable_values}."
      end
      @account_linking_mode = account_linking_mode
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] pkce Object to be assigned
    def pkce=(pkce)
      validator = EnumAttributeValidator.new('String', ["auto", "never", "force"])
      unless validator.valid?(pkce)
        fail ArgumentError, "invalid value for \"pkce\", must be one of #{validator.allowable_values}."
      end
      @pkce = pkce
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] update_identity_on_login Object to be assigned
    def update_identity_on_login=(update_identity_on_login)
      validator = EnumAttributeValidator.new('String', ["never", "automatic"])
      unless validator.valid?(update_identity_on_login)
        fail ArgumentError, "invalid value for \"update_identity_on_login\", must be one of #{validator.allowable_values}."
      end
      @update_identity_on_login = update_identity_on_login
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aal2_acr_values == o.aal2_acr_values &&
          aal2_amr_values == o.aal2_amr_values &&
          account_linking_mode == o.account_linking_mode &&
          ...
          update_identity_on_login == o.update_identity_on_login &&
