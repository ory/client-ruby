...
module OryClient
  class Subscription
    ...
    def valid?
      ...
      current_plan_validator = EnumAttributeValidator.new('String', ["unknown", "free", "start_up_monthly", "start_up_yearly", "business_monthly", "business_yearly", "custom"])
    ...
    def current_plan=(current_plan)
      validator = EnumAttributeValidator.new('String', ["unknown", "free", "start_up_monthly", "start_up_yearly", "business_monthly", "business_yearly", "custom"])
