...
module OryClient
  class RegistrationFlow
    ...
    def hash
      [active, expires_at, id, issued_at, oauth2_login_challenge, oauth2_login_request, request_url, return_to, session_token_exchange_code, transient_payload, type, ui].hash
    end
