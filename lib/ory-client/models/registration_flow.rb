...
module OryClient
  class RegistrationFlow < ApiModelBase
    ...
    def valid?
      ...
      active_validator = EnumAttributeValidator.new('String', ["password", "oidc", "totp", "lookup_secret", "webauthn", "code", "passkey", "profile", "saml", "deviceauthn", "link_recovery", "code_recovery"])
