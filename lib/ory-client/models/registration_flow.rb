...
module OryClient
  class RegistrationFlow < ApiModelBase
    ...
    def hash
      [active, expires_at, id, identity_schema, issued_at, oauth2_login_challenge, oauth2_login_request, organization_id, request_url, return_to, session_token_exchange_code, state, transient_payload, type, ui].hash
    end
