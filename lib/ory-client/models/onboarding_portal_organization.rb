...
module OryClient
  class OnboardingPortalOrganization
    ...
    def hash
      [base_url, kratos_selfservice_methods_oidc_config_providers, kratos_selfservice_methods_saml_config_providers, organization_id, organization_label, revision_id].hash
    end
