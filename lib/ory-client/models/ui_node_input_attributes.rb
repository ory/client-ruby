...
module OryClient
  ...
  class UiNodeInputAttributes < ApiModelBase
    ...
    def valid?
      ...
      autocomplete_validator = EnumAttributeValidator.new('String', ["email", "tel", "url", "current-password", "new-password", "one-time-code", "username webauthn"])
    ...
    def autocomplete=(autocomplete)
      validator = EnumAttributeValidator.new('String', ["email", "tel", "url", "current-password", "new-password", "one-time-code", "username webauthn"])
