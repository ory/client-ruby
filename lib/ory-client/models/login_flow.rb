...
module OryClient
  ...
  class LoginFlow < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'state' => :'Object',
        :'test_context' => :'LoginFlowTestContext',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'test_context')
        self.test_context = attributes[:'test_context']
      end
    ...
    def valid?
      ...
      active_validator = EnumAttributeValidator.new('String', ["password", "oidc", "totp", "lookup_secret", "webauthn", "code", "passkey", "profile", "saml", "deviceauthn", "identifier_first", "link_recovery", "code_recovery"])
    ...
    def hash
      [active, created_at, expires_at, id, identity_schema, issued_at, oauth2_login_challenge, oauth2_login_request, organization_id, refresh, request_url, requested_aal, return_to, session_token_exchange_code, state, test_context, transient_payload, type, ui, updated_at].hash
    end
