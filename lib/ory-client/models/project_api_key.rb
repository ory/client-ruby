...
module OryClient
  class ProjectApiKey < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'last_characters')
        self.last_characters = attributes[:'last_characters']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          last_characters == o.last_characters &&
          name == o.name &&
          owner_id == o.owner_id &&
    ...
    def hash
      [created_at, expires_at, id, last_characters, name, owner_id, project_id, updated_at, value].hash
    end
