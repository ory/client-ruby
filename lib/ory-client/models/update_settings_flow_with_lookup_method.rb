...
module OryClient
  ...
  class UpdateSettingsFlowWithLookupMethod < ApiModelBase
    ...
    attr_accessor :lookup_secret_disable
    ...
    def self.attribute_map
      {
        ...
        :'lookup_secret_disable' => :'lookup_secret_disable',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OryClient::UpdateSettingsFlowWithLookupMethod` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::UpdateSettingsFlowWithLookupMethod`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lookup_secret_disable')
        self.lookup_secret_disable = attributes[:'lookup_secret_disable']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lookup_secret_disable == o.lookup_secret_disable &&
    ...
    def hash
      [csrf_token, lookup_secret_confirm, lookup_secret_disable, lookup_secret_regenerate, lookup_secret_reveal, method, transient_payload].hash
    end
