...
module OryClient
  ...
  class Identity
    ...
    def hash
      [created_at, credentials, id, metadata_admin, metadata_public, organization_id, recovery_addresses, schema_id, schema_url, state, state_changed_at, traits, updated_at, verifiable_addresses].hash
    end
