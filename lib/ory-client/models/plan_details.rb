...
module OryClient
  class PlanDetails < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'custom' => :'Boolean',
        :'description' => :'String',
        :'development_features' => :'Hash<String, Usage>',
        :'features' => :'Hash<String, Usage>',
        :'latest' => :'Boolean',
        :'name' => :'String',
        :'production_features' => :'Hash<String, Usage>',
        :'staging_features' => :'Hash<String, Usage>',
        :'version' => :'Integer',
        :'yearly_only' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'yearly_only')
        self.yearly_only = attributes[:'yearly_only']
      else
        self.yearly_only = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @yearly_only.nil?
        invalid_properties.push('invalid value for "yearly_only", yearly_only cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @yearly_only.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] yearly_only Value to be assigned
    def yearly_only=(yearly_only)
      if yearly_only.nil?
        fail ArgumentError, 'yearly_only cannot be nil'
      end
    ...
    def hash
      [base_fee_monthly, base_fee_yearly, custom, description, development_features, features, latest, name, production_features, staging_features, version, yearly_only].hash
    end
