...
The version of the OpenAPI document: v1.22.53
...
module OryClient
  ...
  class CreateProjectNormalizedPayload < ApiModelBase
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
    ...
    def valid?
      ...
      return false if !@hydra_oauth2_grant_jwt_max_ttl.nil? && @hydra_oauth2_grant_jwt_max_ttl !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      ...
      return false if !@hydra_ttl_access_token.nil? && @hydra_ttl_access_token !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@hydra_ttl_auth_code.nil? && @hydra_ttl_auth_code !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@hydra_ttl_id_token.nil? && @hydra_ttl_id_token !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@hydra_ttl_login_consent_request.nil? && @hydra_ttl_login_consent_request !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      ...
      return false if !@talos_cache_ttl.nil? && @talos_cache_ttl !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@talos_credentials_api_keys_default_ttl.nil? && @talos_credentials_api_keys_default_ttl !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@talos_credentials_api_keys_max_ttl.nil? && @talos_credentials_api_keys_max_ttl !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@talos_credentials_derived_tokens_default_ttl.nil? && @talos_credentials_derived_tokens_default_ttl !~ Regexp.new(/^(\d+(\.\d+)?(ns|us|µs|ms|s|m|h))+$/)
      true
    end
