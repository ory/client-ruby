...
module OryClient
  class Project
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::Project`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      home_region_validator = EnumAttributeValidator.new('String', ["eu-central", "us-east", "us-west", "global"])
    ...
    def home_region=(home_region)
      validator = EnumAttributeValidator.new('String', ["eu-central", "us-east", "us-west", "global"])
    ...
    def hash
      [cors_admin, cors_public, environment, home_region, id, name, revision_id, services, slug, state, workspace_id].hash
    end
