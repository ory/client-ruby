...
module OryClient
  class Project
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'String',
        :'ongoing_stripe_checkout_id' => :'NullString',
        :'revisions' => :'Array<ProjectRevision>',
        :'slug' => :'String',
        :'state' => :'String',
        :'subscription_id' => :'NullUUID',
        :'updated_at' => :'Time'
      }
    end
    ...
    def hash
      [created_at, current_revision, id, ongoing_stripe_checkout_id, revisions, slug, state, subscription_id, updated_at].hash
    end
