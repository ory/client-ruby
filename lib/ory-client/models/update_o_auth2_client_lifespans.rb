...
module OryClient
  ...
  class UpdateOAuth2ClientLifespans
    ...
    attr_accessor :password_grant_access_token_lifespan

    attr_accessor :password_grant_refresh_token_lifespan
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OryClient::UpdateOAuth2ClientLifespans` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::UpdateOAuth2ClientLifespans`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'password_grant_access_token_lifespan')
        self.password_grant_access_token_lifespan = attributes[:'password_grant_access_token_lifespan']
      end

      if attributes.key?(:'password_grant_refresh_token_lifespan')
        self.password_grant_refresh_token_lifespan = attributes[:'password_grant_refresh_token_lifespan']
      end
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^[0-9]+(ns|us|ms|s|m|h)$/)
      if !@password_grant_access_token_lifespan.nil? && @password_grant_access_token_lifespan !~ pattern
        invalid_properties.push("invalid value for \"password_grant_access_token_lifespan\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^[0-9]+(ns|us|ms|s|m|h)$/)
      if !@password_grant_refresh_token_lifespan.nil? && @password_grant_refresh_token_lifespan !~ pattern
        invalid_properties.push("invalid value for \"password_grant_refresh_token_lifespan\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if !@password_grant_access_token_lifespan.nil? && @password_grant_access_token_lifespan !~ Regexp.new(/^[0-9]+(ns|us|ms|s|m|h)$/)
      return false if !@password_grant_refresh_token_lifespan.nil? && @password_grant_refresh_token_lifespan !~ Regexp.new(/^[0-9]+(ns|us|ms|s|m|h)$/)
    ...
    # Custom attribute writer method with validation
    # @param [Object] password_grant_access_token_lifespan Value to be assigned
    def password_grant_access_token_lifespan=(password_grant_access_token_lifespan)
      pattern = Regexp.new(/^[0-9]+(ns|us|ms|s|m|h)$/)
      if !password_grant_access_token_lifespan.nil? && password_grant_access_token_lifespan !~ pattern
        fail ArgumentError, "invalid value for \"password_grant_access_token_lifespan\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] password_grant_refresh_token_lifespan Value to be assigned
    def password_grant_refresh_token_lifespan=(password_grant_refresh_token_lifespan)
      pattern = Regexp.new(/^[0-9]+(ns|us|ms|s|m|h)$/)
      if !password_grant_refresh_token_lifespan.nil? && password_grant_refresh_token_lifespan !~ pattern
        fail ArgumentError, "invalid value for \"password_grant_refresh_token_lifespan\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password_grant_access_token_lifespan == o.password_grant_access_token_lifespan &&
          password_grant_refresh_token_lifespan == o.password_grant_refresh_token_lifespan &&
