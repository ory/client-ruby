...
module OryClient
  class AccountExperienceConfiguration < ApiModelBase
    ...
    def hash
      [default_locale, default_redirect_url, enabled_locales, error_ui_url, favicon_dark_url, favicon_light_url, hide_ory_branding, hide_registration_link, locale_behavior, login_ui_url, logo_dark_url, logo_light_url, name, recovery_enabled, recovery_ui_url, registration_enabled, registration_ui_url, settings_ui_url, stylesheet, translations, verification_enabled, verification_ui_url].hash
    end
