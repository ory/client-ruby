...
module OryClient
  class AccountExperienceConfiguration
    ...
    def hash
      [account_experience_theme_stylesheet, kratos_selfservice_flows_recovery_enabled, kratos_selfservice_flows_registration_enabled, kratos_selfservice_flows_verification_enabled, organization_map].hash
    end
