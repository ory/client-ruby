...
module OryClient
  class AccountExperienceConfiguration < ApiModelBase
    ...
    attr_accessor :hide_ory_branding

    attr_accessor :hide_registration_link
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'hide_ory_branding')
        self.hide_ory_branding = attributes[:'hide_ory_branding']
      else
        self.hide_ory_branding = nil
      end

      if attributes.key?(:'hide_registration_link')
        self.hide_registration_link = attributes[:'hide_registration_link']
      else
        self.hide_registration_link = nil
      end
    ...
    def list_invalid_properties
      ...
      if @enabled_locales.nil?
        invalid_properties.push('invalid value for "enabled_locales", enabled_locales cannot be nil.')
      end
      ...
      if @hide_ory_branding.nil?
        invalid_properties.push('invalid value for "hide_ory_branding", hide_ory_branding cannot be nil.')
      end

      if @hide_registration_link.nil?
        invalid_properties.push('invalid value for "hide_registration_link", hide_registration_link cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @enabled_locales.nil?
      return false if @error_ui_url.nil?
      return false if @hide_ory_branding.nil?
      return false if @hide_registration_link.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] enabled_locales Value to be assigned
    def enabled_locales=(enabled_locales)
      if enabled_locales.nil?
        fail ArgumentError, 'enabled_locales cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] hide_ory_branding Value to be assigned
    def hide_ory_branding=(hide_ory_branding)
      if hide_ory_branding.nil?
        fail ArgumentError, 'hide_ory_branding cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] hide_registration_link Value to be assigned
    def hide_registration_link=(hide_registration_link)
      if hide_registration_link.nil?
        fail ArgumentError, 'hide_registration_link cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          hide_ory_branding == o.hide_ory_branding &&
          hide_registration_link == o.hide_registration_link &&
    ...
    def hash
      [contact_url, default_locale, default_redirect_url, enabled_locales, error_ui_url, favicon_dark_url, favicon_light_url, hide_ory_branding, hide_registration_link, locale_behavior, login_ui_url, logo_dark_url, logo_light_url, name, privacy_policy_url, recovery_enabled, recovery_ui_url, registration_enabled, registration_ui_url, settings_ui_url, stylesheet, terms_of_service_url, translations, verification_enabled, verification_ui_url].hash
    end
