...
module OryClient
  ...
  class ContinueWithDeviceAuthnPinEntryUiData < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OryClient::ContinueWithDeviceAuthnPinEntryUiData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::ContinueWithDeviceAuthnPinEntryUiData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enc')
        self.enc = attributes[:'enc']
      else
        self.enc = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @enc.nil?
        invalid_properties.push('invalid value for "enc", enc cannot be nil.')
      end
    ...
    # @param [Object] ciphertext Value to be assigned
    def ciphertext=(ciphertext)
      if ciphertext.nil?
        fail ArgumentError, 'ciphertext cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] enc Value to be assigned
    def enc=(enc)
      if enc.nil?
        fail ArgumentError, 'enc cannot be nil'
      end
