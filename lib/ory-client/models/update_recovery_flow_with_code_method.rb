...
module OryClient
  ...
  class UpdateRecoveryFlowWithCodeMethod < ApiModelBase
    ...
    attr_accessor :recovery_address
    ...
    attr_accessor :recovery_confirm_address
    ...
    attr_accessor :recovery_select_address
