...
module OryClient
  ...
  class UiNode
    ...
    def valid?
      ...
      group_validator = EnumAttributeValidator.new('String', ["default", "password", "oidc", "profile", "link", "code", "totp", "lookup_secret", "webauthn", "passkey"])
      return false unless group_validator.valid?(@group)
      return false if @messages.nil?
      return false if @meta.nil?
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["text", "input", "img", "a", "script"])
    ...
    def group=(group)
      validator = EnumAttributeValidator.new('String', ["default", "password", "oidc", "profile", "link", "code", "totp", "lookup_secret", "webauthn", "passkey"])
