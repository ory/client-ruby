...
module OryClient
  ...
  class UiNode < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::UiNode`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      group_validator = EnumAttributeValidator.new('String', ["default", "password", "oidc", "profile", "link", "code", "totp", "lookup_secret", "webauthn", "passkey", "identifier_first", "captcha", "saml", "deviceauthn", "oauth2_consent"])
      return false unless group_validator.valid?(@group)
      return false if @messages.nil?
      return false if @meta.nil?
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["text", "input", "img", "a", "script", "div"])
    ...
    def group=(group)
      validator = EnumAttributeValidator.new('String', ["default", "password", "oidc", "profile", "link", "code", "totp", "lookup_secret", "webauthn", "passkey", "identifier_first", "captcha", "saml", "deviceauthn", "oauth2_consent"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["text", "input", "img", "a", "script", "div"])
