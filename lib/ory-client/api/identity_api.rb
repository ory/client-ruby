...
module OryClient
  class IdentityApi
    ...
    # @param create_test_login_flow_body [CreateTestLoginFlowBody] 
    # @param [Hash] opts the optional parameters
    # @return [LoginFlow]
    def create_test_login_flow(create_test_login_flow_body, opts = {})
      data, _status_code, _headers = create_test_login_flow_with_http_info(create_test_login_flow_body, opts)
      data
    end
    ...
    def create_test_login_flow_with_http_info(create_test_login_flow_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IdentityApi.create_test_login_flow ...'
      end
      # verify the required parameter 'create_test_login_flow_body' is set
      if @api_client.config.client_side_validation && create_test_login_flow_body.nil?
        fail ArgumentError, "Missing the required parameter 'create_test_login_flow_body' when calling IdentityApi.create_test_login_flow"
      end
      # resource path
      local_var_path = '/admin/test-login-flows'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_test_login_flow_body)
      ...
      new_options = opts.merge(
        :operation => :"IdentityApi.create_test_login_flow",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IdentityApi#create_test_login_flow\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :identifier Identifier is the identifier of the credential to delete. It is required for the &#x60;oidc&#x60;, &#x60;saml&#x60;, and &#x60;deviceauthn&#x60; credential types: for &#x60;oidc&#x60; and &#x60;saml&#x60; it selects the provider link to remove, for &#x60;deviceauthn&#x60; it is the &#x60;client_key_id&#x60; of the device key to revoke. Find the identifier by calling the &#x60;GET /admin/identities/{id}?include_credential&#x3D;{type}&#x60; endpoint.
    # @return [nil]
    ...
    def delete_identity_credentials_with_http_info(id, type, opts = {})
      ...
      # verify enum value
      allowable_values = ["password", "oidc", "totp", "lookup_secret", "webauthn", "code", "passkey", "profile", "saml", "deviceauthn", "identifier_first", "link_recovery", "code_recovery"]
    ...
    # @param external_id [String] ExternalID must be set to the ID of identity you want to get
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :include_credential Include Credentials in Response  Include any credential, for example &#x60;password&#x60; or &#x60;oidc&#x60;, in the response. When set to &#x60;oidc&#x60;, This will return the initial OAuth 2.0 Access Token, OAuth 2.0 Refresh Token, and the OpenID Connect ID Token if available.
    # @return [Identity]
    ...
    # @option opts [Integer] :page_size Page Size  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). (default to 250)
    ...
    # @param manage_sessions_body [ManageSessionsBody] 
    # @param [Hash] opts the optional parameters
    # @return [ManageSessionsResponse]
    def manage_sessions(manage_sessions_body, opts = {})
      data, _status_code, _headers = manage_sessions_with_http_info(manage_sessions_body, opts)
      data
    end
    ...
    # @param manage_sessions_body [ManageSessionsBody] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ManageSessionsResponse, Integer, Hash)>] ManageSessionsResponse data, response status code and response headers
    def manage_sessions_with_http_info(manage_sessions_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IdentityApi.manage_sessions ...'
      end
      # verify the required parameter 'manage_sessions_body' is set
      if @api_client.config.client_side_validation && manage_sessions_body.nil?
        fail ArgumentError, "Missing the required parameter 'manage_sessions_body' when calling IdentityApi.manage_sessions"
      end
      # resource path
      local_var_path = '/admin/sessions'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(manage_sessions_body)

      # return_type
      return_type = opts[:debug_return_type] || 'ManageSessionsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['oryAccessToken']

      new_options = opts.merge(
        :operation => :"IdentityApi.manage_sessions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IdentityApi#manage_sessions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
