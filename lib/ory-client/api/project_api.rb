...
module OryClient
  class ProjectApi
    ...
    # @param resolution [String] The resolution of the buckets  The minimum resolution is 1 minute.
    # @param from [Time] The start RFC3339 date of the time window
    # @param to [Time] The end RFC3339 date of the time window
    # @param [Hash] opts the optional parameters
